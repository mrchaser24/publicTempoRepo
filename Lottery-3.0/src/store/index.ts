...
export default new Vuex.Store({
    state: {
        ...
        currLang: localStorage.getItem('currLang') ? localStorage.getItem('currLang') : 'zh', // current language color `zn`
    },
    mutations: {
        setShowPopupHome(state, status) {
          state.showPopupHome = status;
        },
        setShowAppAdsBanner(state, status) {
          state.showAppAdsBanner = status;
        },
    ...
    actions: {
        setShowPopupHome({commit}, payload) {
          commit("setShowPopupHome", payload)
        },
        setShowAppAdsBanner({commit}, payload) {
          commit("setShowAppAdsBanner", payload)
        },
