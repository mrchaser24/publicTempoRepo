<template>
  <van-popup
    ...
    <div class="popup-content">
      <div class="header">
        <div @click="hideQuestionTypes()">{{ $t('cancel') }}</div>
        <div>{{ $t('selectQuestionType') }}</div>
      </div>
      <div class="content">
        <div class="list">
...
export default class QuestionTypesPopup extends Vue {
  ...
  private questionTypes?: any = [
    ...
    {
      name: this.$t('gameProb'),
      icon: 'cluster-o',
    },
    {
      name: this.$t('preferIssues'),
      icon: 'gift-o',
    },
    {
      name: this.$t('webProb'),
    ...
    {
      name: this.$t('modifyInfo'),
      icon: 'edit',
    },
    {
      name: this.$t('flowProb'),
      icon: 'bar-chart-o',
    },
    {
      name: this.$t('other'),
