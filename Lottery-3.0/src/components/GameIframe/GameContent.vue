...
export default class GameContent extends Vue {
  ...
  private betOptions?: any[] = [
    this.$t("betOptionsAll"),
    this.$t("betOptionsBig"),
    this.$t("betOptionsSmall"),
    this.$t("betOptionsOdd"),
    this.$t("betOptionsEven"),
    this.$t("betOptionsClear"),
  ]
