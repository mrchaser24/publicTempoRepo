<template>
  ...
  <div class="main-detail-recharge">
    <Header :msg="$t('changeWithdrawPassword')" :leftText="$t('back')" :back="true" />
        ...
        <van-cell center title class="top_user">
          ...
          <template #title>
            <van-field
              ...
              type="password"
              :rules="[{ pattern, required: true, message: $t('newPassReq') }]"
            />
          </template>
        </van-cell>
        <van-cell center title class="top_user">
          ...
          <template #title>
            <van-field
              ...
              type="password"
              :rules="[{ pattern, required: true, message: $t('newConfirmPassReq') }]"
            />
          </template>
        </van-cell>
      </div>
        ...
        <van-cell center title class="top_user">
          ...
          <template #title>
            <van-field
              ...
              type="password"
              :rules="[{ pattern, required: true, message: $t('oldPassReq') }]"
            />
          </template>
        </van-cell>
        <van-cell center title class="top_user">
  ...
  private changeWithdrawPass(val: any) {
    if (val.currentPass == this.userData.withdrawPassword) {
      if (val.newPass == val.confirmPass) {
        ...
        Toast.fail(this.$t('newPasswordNotMatch'));
      }
    } else {
      Toast.fail(this.$t('oldPassIncorrect'));
    }
  }
