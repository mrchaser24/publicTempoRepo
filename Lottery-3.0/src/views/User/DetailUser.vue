  ...
  <div class="detail-user">
    ...
    <div class="detail-user-content">
      ...
      <van-cell-group class="link_user info">
        <van-cell center :title="$t('actualName')">
          <template #label>
            <van-field
              v-model="userDetails.name"
              label=""
              :placeholder="$t('realNameMust')"
            />
          </template>
          <template #right-icon>
        ...
        <van-cell
          ...
          :label="userDetails.sex ? userDetails.sex : $t('chooseYourGender')"
        >
          <template #right-icon>
            <van-icon name="arrow" class="arrow" />
          </template>
      ...
      <van-action-sheet v-model="showAvatar" @cancel="onCancelAvatar" :cancel-text="$t('cancel')">
        <div class="content">
    ...
    if (this.userDetails.name == '') {
      ...
      if (validators.checkEmail(this.userDetails.email) === true && this.userDetails.email !== '') {
        ...
        UserInfoCoreService.Update(params).then((data: any) => {
          this.UserInfo();
          Toast.success(this.$t('userUpdate'));
        })
      } else {
        Toast(this.$t('invalidEmail'))
      }
