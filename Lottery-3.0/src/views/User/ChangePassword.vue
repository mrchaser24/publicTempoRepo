<template>
  <div class="main-detail-recharge">
    <Header :msg="$t('changePassword')" :leftText="$t('back')" :back="true" />
<!-- 
    /*
    * @Author: chase 
    * @LastAuthor: keanu
    ...
    * @Return null
    * @Date: 2021-08-04
    * @Description: create new web page Change Password
    */ -->
    <van-form @submit="changePass">
        <van-cell center title class="top_user">
          ...
          <template #title>
            <van-field
              ...
              name="currentPass"
              :label="$t('oldPass') + '：'" 
              :placeholder="$t('oldPassLabel')"
              type="password"
              :rules="[{ required: true, message: $t('oldPassReq') }]"
            />
          </template>
        </van-cell>
        <van-cell center title class="top_user">
          ...
          <template #title>
            <van-field
              ...
              :rules="[{ required: true, message: $t('newPassReq') }]"
            />
          </template>
        </van-cell>
        <van-cell center title class="top_user">
          ...
          <template #title>
            <van-field
              ...
              type="password"
              :rules="[{ required: true, message: $t('newConfirmPassReq') }]"
            />
          </template>
        </van-cell>
...
export default class changePassword extends Vue {
  ...
  /*
    ...
    * @Param: null
    * @Return: array || []
    * @Date: 2021-04-16 14:00:23
    * @Description: change withdraw password
  */
  private changePass(val: any) {
    console.log(val);
  }
