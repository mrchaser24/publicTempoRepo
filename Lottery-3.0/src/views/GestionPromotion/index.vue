<template>
  <div>
    <Header :back="true" :msg="$t('newPromotion')" :leftText="$t('sponsoredLinks')" />
    ...
    >
      <div class="wrapper">
        ...
        <van-row class="list-item">
          <h2 class="title">{{ $t('bonusSetting') }}</h2>
        </van-row>
        <van-row
          v-for="item in list"
          :key="item.id"
...
export default class Page extends Vue {
  ...
  private list: any[] = [
    {
      id: 4,
      name: this.$t('setBonus'),
      description: "选择其他奖金组",
      active: false,
    },
    {
      id: 5,
      name: this.$t('setSportsRebates'),
      description: "选择其他返点比例",
      active: false,
    },
    {
      id: 6,
      name: this.$t('setRealPerson'),
      description: "选择其他返点比例",
      active: false,
    },
    {
