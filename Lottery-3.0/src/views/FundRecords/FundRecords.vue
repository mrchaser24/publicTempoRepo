...
export default class FundRecords extends Vue {
  ...
  private currType?: any = this.$t('all');
  ...
  private typeSelection?: any = [
    this.$t('all'), // All
    this.$t('withdrawal'),// Withdrawal
    // this.$t('deposit'),// deposit
    // this.$t('transferOut'),// Transfer out
    // this.$t('transferIn'),// Transfer in
    // this.$t('discount'),// Offer
    // this.$t('rebate'),// Rebate
    // this.$t('jackpot'),// Jackpot
    // this.$t('deduction'),// Deduction
    // this.$t('recommend'),// recommend
    // this.$t('rebate'),// Rebate
    // this.$t('withdrawAndReturn'),// Withdrawal and return
    this.$t('other')// other
  ];
