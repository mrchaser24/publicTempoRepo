<template>
  <div class="bet-record">
    <Header :msg="$t('betRecord')" :leftText="$t('back')" :back="true" />
          ...
          >
            ...
            >
              <div class="list-item-header">
                ...
                <div class="details">
                  <div>{{ $t('numTransaction') }}: {{ item.entries }}</div>
                  <div>{{ $t('runningWater') }}: {{ item.turnOver }}</div>
                  <div>{{ $t('winLose') }}: {{ item.winLose }}</div>
                </div>
              </div>
              <div class="list-item-content">
                ...
                <div class="content-body">
                  ...
                  <div class="row2">{{ $t('odds') }}: {{ item.odds }}</div>
                  <div class="row3">
                    <div>{{ $t('runningWater') }}: <span class="c-color">{{ item.totalTurnOver }}</span></div>
                    <div>{{ $t('winLose') }}: <span class="c-color">{{ item.totalWinLose }}</span></div>
                  </div>
                </div>
                <div class="content-footer">
                  <div>{{ $t('betTime') }}: {{ item.betTime }}</div>
                </div>
              </div>
            </div>
          </van-list>
...
export default class AllBetRecord extends Vue {
  private currGameTitle?: any = this.$t('all')
  private currDateTitle?: any = this.$t('today')
  ...
  private gameTitleItems?: any = [this.$t('all'), this.$t('aaLottery')]
