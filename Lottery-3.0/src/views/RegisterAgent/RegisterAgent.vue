        ...
        <div class="rg-wrapper">
          <van-form @submit="onSubmit" class="rg-reg-form">
            <div class="form-group">
              <div class="rg-heading">{{ $t('accInfo') }}</div>
              <div class="rg-form-group">
                <label>
                  <span>{{ $t('proxyAcc') }}：</span>
                </label>
                <van-field
                  v-model="account.value"
                  type="input"
                  name="vAccount"
                  :rules="[{ validator: vAccount, message: $t('enterCorrectAcc') }]"
                />
              </div>
              <div class="rg-form-group">
                <label>
                ...
                <van-field
                  ...
                  type="password"
                  name="vPassword"
                  :rules="[{ validator: vPassword, message: $t('mustLetterNumber') }]"
                />
              </div>
              <div class="rg-form-group">
                <label>
                  <span>{{ $t('confirmPass') }}：</span>
                </label>
                <van-field
                  v-model="confirmPassword.value"
                  type="password"
                  name="vConfirmPassword"
                  :rules="[{ validator: vConfirmPassword, message: $t('mustLetterNumber') }]"
                />
              </div>
              <div class="rg-heading acct-info">{{ $t('userInfo') }}</div>
              <div>
                <div class="rg-form-group">
                  <label>
                    <span>{{ $t('actualName') }}：</span>
                  </label>
                  <van-field
                    v-model="name.value"
                    type="string"
                    name="vName"
                    :rules="[{ validator: vName, message: $t('validationDesc') }]"
                  />
                </div>
              </div>
              <div>
              ...
              <div>
                <div class="rg-form-group">
                  ...
                  <van-field
                    ...
                    type="input"
                    name="vQQ"
                    :rules="[{ validator: vQQ, message: $t('qqIsIllegal') }]"
                  />
                </div>
              </div>
              <div class="rg-heading acct-info">{{ $t('bankInfo') }}</div>
              <div>
                <div class="rg-form-group">
                  <label>
                    <span>{{ $t('payoutBank') }}：</span>
                  </label>
                  <van-field
                    readonly
                    clickable
          ...
          <van-form>
            <div class="rg-reg-btn">
              <van-button
                ...
                class="rg-submit-btn"
                >{{ $t('becomeAnAgent') }}</van-button
              >
            </div>
            <div class="rg-existing">
              <p>
                {{ $t('alreadyHaveAcc') }}
                <span class="rg-login">{{ $t('signInNow') }}!</span>
              </p>
            </div>
          </van-form>
        </div>
...
export default class RegisterAgent extends Vue {
  private pageTitle?: any = this.$t('agencyCenter');
  private value?: any = '';
  private columns?: any = [
