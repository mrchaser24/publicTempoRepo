      ...
      <div class="top-content">
        <div class="user-info">
          <div class="user-info-con">
            <div class="user-name">
              <span>{{$t('username')}}：{{ UserData ? UserData.name : '' }} </span>
            </div>
            <div class="user-balance">
              ...
              /*
                ...
                * @Description: Decimal
              */ -->
              <span>{{$t('balance')}}：{{ UserData.money ? UserData.money : '0.00' }} </span>
          ...
          <div class="recent-game-list-con">
            <div class="recent-picker">
              <span @click="selectFeaturedGame()">
                {{ isRecent ? $t('recentGames') : $t('myCollection') }}
              </span>
              <div class="arrow">
