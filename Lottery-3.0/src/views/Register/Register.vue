            ...
            <div class="form-group">
              ...
              <div class="rg-form-group">
                <van-field
                  ...
                  left-icon="friends"
                  name="username"
                  :rules="[{ pattern, required: true, message: $t('unConsists') }]"
                />
              </div>
              <div class="rg-form-group">
                <van-field
                  ...
                  name="password"
                  :rules="[
                    { pattern, required: true, message: $t('pwConsists') }
                  ]"
                >
                  <template #button>
                    <van-icon
