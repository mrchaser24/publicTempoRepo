...
export default class MyCollection extends Vue {
  ...
  */
  private async GameCollect() {
    ...
    params.equal_userInfo_gameCollect = myFn.getCookie()?.userid;
  ...
  */
  private async ShortVideo() {
    ...
    params.equal_userInfo_shortVideoCollect = myFn.getCookie()?.userid;
  ...
  */
  private async VideoCollect() {
    ...
    params.equal_userInfo_videoCollect = myFn.getCookie()?.userid;
