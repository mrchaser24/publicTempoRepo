<template>
  <div class="com-wrapper">
    <Header :msg="$t('myComment')" :back="true" />
    <van-tabs v-model="activeTab" animated>
      <van-tab :title="$t('video')">
      <PullRefresh
...
export default class MyComments extends Vue {
  ...
  */
  private async VideoComment() {
    ...
    params.equal_userInfo_videoComment = myFn.getCookie()?.userid as any;
  ...
  */
  private async ShortVideoComment() {
    ...
    params.equal_userInfo_shortVideoComment = myFn.getCookie()?.userid as any;
