    ...
    <div class="pr-con">
      ...
      <div class="pr-box">
        ...
        <div class="pr-box-cont">
          ...
          <span class="number">
            <p class="label">{{ $t('mobilePhoneNumber') }} :</p>
...
export default class ProxyReview extends Vue {
  private pageTitle?: any = this.$t('agencyReview');
