<template>
    <div class="quotaConversion">
        <Header :msg="$t('quotaConversion')" :leftText="$t('back')" :back="true" :HomePage="false"/>
        <van-cell-group class="top_quotaConversion">
            <van-cell title :value="$t('oneClickRecycling')">
                <template #title>
                    <span>{{ $t('walletBal') }}</span>
        ...
        <van-grid  :column-num="2" class="info_quotaConversion">
            <van-grid-item>
                <h5><van-icon name="pending-payment" size="19" />{{ $t('centralWallet') }}</h5>
                <p>{{
            ...
            <van-grid-item>
                <h5><van-icon name="pending-payment" size="19" />{{ $t('lockWallet') }}</h5>
                <p>0.00</p>
            </van-grid-item>
        </van-grid>
        ...
        <van-cell center title class="auto_quotaConversion">
            <template #title>
                ...
                <span>{{ $t('autoConversion') }}</span>
                <span class="gray">({{ $t('afterOpenDesc') }})</span>
            </template>
            <template #right-icon>
        ...
        <div class="no_auto_quotation" v-if="!autoQuotaConversion">
            ...
            <p class="txt_account_quotation">{{ $t('theWalletDesc') }}</p>
