            ...
            <div class="user-info">
              <div class="row row-top">
                ...
                <div class="text">
                  ...
                  >
                  <span>{{ $t("welcomeCustomerService") }}</span>
                </div>
              </div>
              <van-divider />
              <div class="row row-bottom">
                <p>{{ $t("addFunChat") }}</p>
                <!-- <van-button class="add-btn">{{ $t('addItNow') }}</van-button> -->
...
export default class CustomerService extends Vue {
  private pageTitle?: any = this.$t("customerService")
  private currentUser: object = {}
  private customerLines?: any[] = [
    {
      name: this.$t("mainlineCustomerService"),
      desc: this.$t("mainCustomerSupport"),
      subDesc: this.$t("7*24"),
      link: "ChatSupport",
    },
    {
