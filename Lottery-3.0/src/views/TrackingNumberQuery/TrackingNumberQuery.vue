            ...
            @load="onLoad">
              <div class="tnq-list-item" v-for="(item, key) in tnqData" :key="key" @click="showPopup">
                <div class="left">
                  ...
                  <div class="body">
                    <span>{{ $t('issue') }}: {{ item.issueNumber }}</span>
                    <span>{{ $t('betNum') }}:{{ item.betNum }}</span>
                    <span>{{ $t('betAmount') }}: {{ item.betAmount }}元</span>
                    <span>{{ $t('awardAmount') }}:{{ item.bonusAmount }}</span>
