    ...
    <div class="to-content">
      <div class="to-top-content" v-if="showDropdown">
        ...
        <div class="bottom-btn">
          <van-button size="small">{{ $t("cancel") }}</van-button>
...
export default class FundRecords extends Vue {
  ...
  private lists?: any = [
    {
      label: this.$t("teamDetails"),
      list: [
        { id: 0, Name: this.$t("numberTeam"), Balance: "" },
        { id: 1, Name: this.$t("currOnline"), Balance: "" },
        { id: 2, Name: this.$t("teamBal"), Balance: "" },
        { id: 3, Name: this.$t("recharge"), Balance: "" },
        { id: 4, Name: this.$t("withdraw"), Balance: "" },
        { id: 5, Name: this.$t("numOfBets"), Balance: "" },
        { id: 6, Name: this.$t("numRegisteredPeople"), Balance: "" },
        { id: 7, Name: this.$t("teamRebate"), Balance: "" },
      ],
    },
    {
      label: this.$t("lotteryGames"),
      list: [
  ...
  private async agencyGroupReportCore() {
    ...
    this.lists[0].list[0].Balance =
      this.AgencyInfo[0].agencyGroupNums + this.$t("people")
    this.lists[0].list[1].Balance =
      this.AgencyInfo[0].onlineNum + this.$t("people")
    this.lists[0].list[2].Balance =
      this.AgencyInfo[0].teamBalance + this.$t("yuan")
    this.lists[0].list[3].Balance = this.AgencyInfo[0].recharge
    this.lists[0].list[4].Balance =
      this.AgencyInfo[0].withdraw + this.$t("yuan")
    this.lists[0].list[5].Balance =
      this.AgencyInfo[0].betPeopleNum + this.$t("people")
    this.lists[0].list[6].Balance =
      this.AgencyInfo[0].registerNum + this.$t("people")
    this.lists[0].list[7].Balance =
      this.AgencyInfo[0].returnMoney + this.$t("yuan")
  }
