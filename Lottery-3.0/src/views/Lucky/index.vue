...
export default class Lucky extends Vue {
  ...
  private rankList?: any = {
    EveryColor: [
      {
        title: this.$t("historicalLottery"),
      ...
      {
        title: this.$t("runnerUp"),
        data: this.runnerUpData,
      },
      {
        title: this.$t("thirdPlace"),
        data: this.thirdPlace,
      },
      {
        title: this.$t("fourthPlace"),
        data: this.fourthPlace,
      },
      {
        title: this.$t("fifthPlace"),
    ...
    CarRace: [
      ...
      {
        title: this.$t("sixthPlace"),
        data: this.sixthPlace,
      },
      {
        title: this.$t("seventhPlace"),
        data: this.seventhPlace,
      },
      {
        title: this.$t("eigthPlace"),
        data: this.eigthPlace,
      },
      {
        title: this.$t("ninthPlace"),
        data: this.ninthPlace,
      },
      {
        title: this.$t("tenthPlace"),
