        ...
        <div class="info-card">
          <div class="info-name">
            ...
            <div class="name">
              ...
              <span>{{ $t("agentLevel") }}: {{ agencyLevel }} </span>
            </div>
...
export default class Agent extends Vue {
  ...
  private agencyLevel?: any = this.$t("juniorAgent")
  private teamList?: any[] = [
    {
      icon: "friends",
      title: this.$t("teamMember"),
      subTitle: this.$t("currentMembers"),
      path: "TeamMember",
    },
    {
      icon: "balance-list",
      title: this.$t("teamMember"),
      subTitle: this.$t("viewReport"),
      path: "TeamOverview",
    },
  ]
  ...
  private exclusiveListData?: any[] = [
    {
      title: this.$t("juniorAgentExclusive"),
      isLink: false,
      linkText: "",
      path: "",
      data: [],
    ...
    {
      title: this.$t("promotionalAgentExclusive"),
      isLink: false,
      linkText: "",
      path: "",
      data: [],
