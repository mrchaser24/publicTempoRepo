    ...
    <div class="info_redeem">
      ...
      <van-grid direction="horizontal" :column-num="2">
        ...
        <van-grid-item icon text is-link to="GameIframe">
          <template #text>
            <div class="text-info">
              <h3>{{ $t('markingToEarnPoints') }}</h3>
              <p>{{ $t('youCanEarnPoints') }}</p>
            </div>
          </template>
          <template #icon>
...
export default class redeem extends Vue {
  ...
  private dialogOptions?: object | any = {
    ...
    confirmButtonText: this.$t('confirmExchange'),
    lockScroll: true,
