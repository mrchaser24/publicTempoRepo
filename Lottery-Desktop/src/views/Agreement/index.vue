<template>
    <div :class="'skin_'+colorSetting">
        <div class="user_win"  style="background-image: none;">
	<div class="agree_win" > 
            	...
            	<div class="win_info" >
                	<ul>
                        ...
                        <li class="user_winbu">
                            <div >
                                <span>
                                    <a class="no"  @click="logout()">不同意</a>
                                    <a class="yes" @click="acceptAgreement()" >同意</a>
                                </span>
                            </div>
                        </li>
                	</ul>
...
export default class Agreement extends Vue {
  ...
  // private logout(){
  //     UserService.LogOut({ _token: this.token }).then(response => {
  //         if (response.state == 0) {
